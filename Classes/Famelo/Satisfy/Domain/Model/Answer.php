...
class Answer {
	...
	/**
	 * The survey
	 * @var \Famelo\Satisfy\Domain\Model\Survey
	...
	/**
	 * The question
	 * @var \Famelo\Satisfy\Domain\Model\Question
	 * @ORM\ManyToOne(inversedBy="answers", cascade={"all"})
	 */
	protected $question;
	 ...
	 *
	 * @return \Famelo\Satisfy\Domain\Model\Question The Answer's question
	 */
	 ...
	 *
	 * @param \Famelo\Satisfy\Domain\Model\Question $question The Answer's question
	 * @return void
	 */
	...
	/**
	 * @return \Famelo\Satisfy\Domain\Model\Survey
	 */
