...
class Survey {
	...
	/**
	 * The rating
	 * @var \Famelo\Satisfy\Domain\Model\Rating
	...
	/**
	 * The answers
	 * @var \Doctrine\Common\Collections\Collection<\Famelo\Satisfy\Domain\Model\Answer>
	 ...
	 *
	 * @return \Famelo\Satisfy\Domain\Model\Customer The Survey's customer
	 */
	 ...
	 *
	 * @param \Famelo\Satisfy\Domain\Model\Customer $customer The Survey's customer
	 * @return void
	 */
	 ...
	 *
	 * @return \Famelo\Satisfy\Domain\Model\Rating The Survey's rating
	 */
	 ...
	 *
	 * @param \Famelo\Satisfy\Domain\Model\Rating $rating The Survey's rating
	 * @return void
	 */
	 ...
	 *
	 * @return \Doctrine\Common\Collections\Collection<\Famelo\Satisfy\Domain\Model\Answer>
	 */
	 ...
	 *
	 * @param \Doctrine\Common\Collections\Collection<\Famelo\Satisfy\Domain\Model\Answer> $answers The Survey's answers
	 * @return void
	 */
	 ...
	 * Sets this Survey's answers
	 *
	 * @param \Famelo\Satisfy\Domain\Model\Answer $answer The Survey's answer
	 * @return void
	 */
