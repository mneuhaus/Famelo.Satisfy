...
class User extends \TYPO3\Party\Domain\Model\Person {
	...
	public function __construct($autoCreateAccount = TRUE) {
		if ($this->accounts == NULL && $autoCreateAccount === TRUE) {
			parent::__construct();
			$account = new \TYPO3\Flow\Security\Account();
			$account->setAuthenticationProviderName('SatisfyProvider');
	 ...
	 *
	 * @return \Famelo\Satisfy\Domain\Model\Branch The User's branch
	 */
	 ...
	 *
	 * @param \Famelo\Satisfy\Domain\Model\Branch $branch The User's branch
	 * @return void
	 */
	 ...
	 *
	 * @return \Doctrine\Common\Collections\Collection<\Famelo\Satisfy\Domain\Model\Customer>
	 */
	 ...
	 *
	 * @param \Doctrine\Common\Collections\Collection<\Famelo\Satisfy\Domain\Model\Customer> $customers The User's customers
	 * @return void
	 */
