...
class Branch {
	...
	/**
	 * The branch
	 * @var \Doctrine\Common\Collections\Collection<\Famelo\Satisfy\Domain\Model\Branch>
	 * @ORM\OneToMany(targetEntity="\Famelo\Satisfy\Domain\Model\Branch", mappedBy="branch")
	 * @Flow\Lazy
	 */
	protected $children;
	 ...
	 *
	 * @return \Doctrine\Common\Collections\Collection<\Famelo\Satisfy\Domain\Model\Question> The branch's questions
	 */
	 ...
	 *
	 * @param \Doctrine\Common\Collections\Collection<\Famelo\Satisfy\Domain\Model\Question> $questions The branch's questions
	 * @return void
	 */
	...
	/**
	 * @param \Doctrine\Common\Collections\Collection<\Famelo\Satisfy\Domain\Model\Branch> $children
	 */
	...
	/**
	 * @return \Doctrine\Common\Collections\Collection<\Famelo\Satisfy\Domain\Model\Branch>
	 */
