...
class Version20121103211555 extends AbstractMigration {
	...
	public function up(Schema $schema) {
		...
		$this->addSql("CREATE TABLE famelo_adu_domain_model_branch (persistence_object_identifier VARCHAR(40) NOT NULL, name VARCHAR(255) NOT NULL, branch VARCHAR(255) NOT NULL, questions LONGTEXT NOT NULL COMMENT '(DC2Type:array)', PRIMARY KEY(persistence_object_identifier)) ENGINE = InnoDB");
